...
bot.on('message', message => {
    ...
    if (msg.startsWith(prefix + 'PURGE')) { // This time we have to use startsWith, since we will be adding a number to the end of the command.
        ...
        async function purge() {
            ...
            if (!message.member.roles.find("name", "host")) { // This checks to see if they DONT have it, the "!" inverts the true/false
...
bot.login('MzcyNTQ0NjA0MDM1MzUwNTMx.Dhe_ZA.zVXmXCBITSX5eEM5T_pzoGHzzQY');
